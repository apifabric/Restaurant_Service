...
def expose_models(api, method_decorators = []): 
    ...
    """
    api.expose_object(database.models.Delivery, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.Promo, method_decorators= method_decorators)
    api.expose_object(database.models.RestaurantSchedule, method_decorators= method_decorators)
    api.expose_object(database.models.Review, method_decorators= method_decorators)
    api.expose_object(database.models.UserPreference, method_decorators= method_decorators)
    return api
