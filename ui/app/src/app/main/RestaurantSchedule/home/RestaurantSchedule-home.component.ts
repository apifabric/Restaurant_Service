...
@Component({
  selector: 'RestaurantSchedule-home',
  templateUrl: './RestaurantSchedule-home.component.html',
  styleUrls: ['./RestaurantSchedule-home.component.scss']
})
export class RestaurantScheduleHomeComponent implements AfterViewInit {
